...
from .mmvae_own import MOE as VAE_2mods
from .mmvae_own import POE as VAE_2mods_poe
...
__all__ = [VAE_2mods, VAE_mnist, VAE_svhn, VAE_cubIS, VAE_cubS,
           VAE_cubI, VAE_cubISft, VAE_cubIft, VAE_imgcol, VAE_imgtxt, VAE_uni, VAE_2mods_poe]
